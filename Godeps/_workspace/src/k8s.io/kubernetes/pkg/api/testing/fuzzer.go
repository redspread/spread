...
import (
	...
	"rsprd.com/spread/Godeps/_workspace/src/k8s.io/kubernetes/pkg/api"
	"rsprd.com/spread/Godeps/_workspace/src/k8s.io/kubernetes/pkg/api/resource"
	"rsprd.com/spread/Godeps/_workspace/src/k8s.io/kubernetes/pkg/api/testapi"
	"rsprd.com/spread/Godeps/_workspace/src/k8s.io/kubernetes/pkg/api/unversioned"
	"rsprd.com/spread/Godeps/_workspace/src/k8s.io/kubernetes/pkg/fields"
	"rsprd.com/spread/Godeps/_workspace/src/k8s.io/kubernetes/pkg/labels"
	"rsprd.com/spread/Godeps/_workspace/src/k8s.io/kubernetes/pkg/runtime"
	"rsprd.com/spread/Godeps/_workspace/src/k8s.io/kubernetes/pkg/types"
	"rsprd.com/spread/Godeps/_workspace/src/k8s.io/kubernetes/pkg/util/intstr"

	"rsprd.com/spread/Godeps/_workspace/src/github.com/google/gofuzz"
)
