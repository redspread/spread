...
import (
	...
	labelsutil "rsprd.com/spread/Godeps/_workspace/src/k8s.io/kubernetes/pkg/util/labels"
	podutil "rsprd.com/spread/Godeps/_workspace/src/k8s.io/kubernetes/pkg/util/pod"
)
